...
import { redirect, type NumericRange, error } from '@sveltejs/kit';
...
export async function ensureAuthenticated(session: Session | null, redirectTo: string = '/signin'): Promise<{ tokenInfo: TokenInfo, session: Session }> {
